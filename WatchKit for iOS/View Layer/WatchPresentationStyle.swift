...
enum WatchPresentationStyle {
    ...
    func transition(_ direction: WatchPresentationDirection, to controller: WKInterfaceController, in storyboard: WatchStoryboard) {
        ...
        animate(controller, storyboard)
    }
    
    
    //MARK: - Modal Presentation
    
    private func forwardModal(to controller: WKInterfaceController, in storyboard: WatchStoryboard) {
    ...
    private func backwardsModal(to controller: WKInterfaceController, in storyboard: WatchStoryboard) {
        guard let currentView = storyboard.contentView.subviews.first else { return }
        guard let newView = controller.view else { return }
    ...
    private func forwardPush(to controller: WKInterfaceController, in storyboard: WatchStoryboard) {
        guard let currentView = storyboard.contentView.subviews.first else { return }
        guard let newView = controller.view else { return }
    ...
    private func backwardsPush(to controller: WKInterfaceController, in storyboard: WatchStoryboard) {
        guard let currentView = storyboard.contentView.subviews.first else { return }
        guard let newView = controller.view else { return }
